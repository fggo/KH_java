...
<body>
  <div class="container jumbotron card col-md-6 my-3 mx-3 px-3 py-3">
    <h3>기본날짜표현</h3>
    <p>
    ...
    <h3>Function Tag</h3>
    <p>
      JSTL이 제공하는 메소드를 이용하는 태그<br>
      <c:set var="str" value="How are you?" />
      모든문자를 대문자로 : ${fn:toUpperCase(str)}<br>
      index찾기: ${fn:indexOf(str, "you")}<br>
    </p>
